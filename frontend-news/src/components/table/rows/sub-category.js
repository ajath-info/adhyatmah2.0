          ...
          {isLoading ? (
            ...
            <ThumbImgStyle>
              <BlurImage
                priority
                fill
                alt={row?.name || 'Unknown SubCategory'}
          ...
          {isLoading ? (
            ...
            <ThumbImgStyle>
              <BlurImage
                priority
                fill
                alt={row?.parentCategory?.name || 'Unknown Category'}
                src={row?.parentCategory?.cover?.url || '/placeholder-image.jpg'}
                objectFit="cover"
              />
            </ThumbImgStyle>
          ) : (
            <ThumbImgStyle>
              <BlurImage priority fill alt="No Category" src="/placeholder-image.jpg" objectFit="cover" />
            </ThumbImgStyle>
          )}
          <Typography variant="subtitle2" noWrap>
            {isLoading ? (

...
// Font registration removed to avoid font format errors
// Using default fonts instead
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>adhyatmah</Text>
            <Text style={styles.body1}>London, England</Text>
            <Text style={styles.body1}>+91 98765 43210</Text>
            <Text style={styles.body1}> info@adhyatmah.com</Text>
          </View>
          <View style={styles.col6}>
            <Text style={[styles.overline, styles.mb8]}>Invoice to</Text>
            <Text style={styles.body1}>{data?.user?.firstName && data?.user?.lastName ? `${data.user.firstName} ${data.user.lastName}` : data?.user?.firstName || data?.user?.lastName || 'N/A'}</Text>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableBody}>
            {data?.items.map((item, index) => (
              <View style={styles.tableRow} key={item.id || item._id || index}>
                <View style={styles.tableCell_1}>
                  <Text>{index + 1}</Text>
                </View>
                <View style={styles.tableCell_2}>

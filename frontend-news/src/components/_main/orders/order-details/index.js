            ...
            {isLoading ? (
              ...
              <>
                <Typography variant="body2">
                  <strong>Name</strong>: {user?.firstName && user?.lastName ? `${user.firstName} ${user.lastName}` : user?.firstName || user?.lastName || 'N/A'}
                </Typography>
                <Typography variant="body2">
        ...
        <CardContent className="detail-card-content">
          ...
          <Stack spacing={isLoading ? 0 : 1} mt={3}>
            {isLoading ? (
              ...
              <>
                <Typography variant="body2">
                  <strong>Method</strong>: {data?.paymentMethod === 'COD' ? 'Cash On Delivery' : data?.paymentMethod}
                </Typography>
                {data?.paymentId && (
                  <Typography variant="body2">

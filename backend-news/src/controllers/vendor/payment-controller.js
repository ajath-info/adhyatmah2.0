...
/*    Get Payments by Vendor (Vendor Protected)    */
...
/*     Get Total Income by Vendor (Vendor Protected)    */
...
/*     Get Payment Details by ID for Vendor    */
const getPaymentDetailsByIdByVendor = async (req, res) => {
  try {
